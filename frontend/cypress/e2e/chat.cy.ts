describe('Chat', () => {
  ...
  it('should display message input', () => {
    ...
    cy.get('button[matTooltip="Send message"]').should('exist');
  });
  ...
  it('should send a message', () => {
    ...
    cy.get('input[placeholder*="message"]').type('Test message from Cypress');
    cy.get('button[matTooltip="Send message"]').click();
